...
const MainFooter = () => {
  return (
    <footer className="text-center bg-zinc-900 text-white mt-20">
      <div className="container px-6 pt-6">
        <div className="flex justify-center mb-6">
          <a
            href="https://www.linkedin.com/in/morgan-lombard-37502976/"
            type="button"
            ...
            <div className="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
              ...
              <div className="md:mb-6">
                <input
                  type="text"
                  className="
                border-2 rounded-full py-2 px-8 cursor-pointer text-base border-violet-500
                form-control
                block
                w-full
                font-normal
